...
Examples: 
renamejs <folder_path> -p <prefix>
renamejs <folder_path> -s <suffix>
renamejs <folder_path> -p <prefix> -s <suffix>
renamejs <folder_path> --rename-dir
renamejs <folder_path> --recursive
renamejs <folder_path> -p <prefix> -s <suffix> --recursive --rename-dir
    `
  );
  process.exit();
}
...
if (args[2]) {
  ...
  console.error(chalk.red("Directory path is required. renamejs /dir/path"));
}
